## ============================================================
##  vikingo.gd  — Freedom Knight
##  Enemigo tipo Vikingo. Aparece a partir de 70 muertes totales.
##  Más rápido y resistente que el Caballero Malo.
##  Comparte la misma lógica de IA que caballero_malo.gd.
## ============================================================
...
@export var speed: float = 115.0          # +35% vs Caballero Malo (85)
@export var stop_distance: float = 72.0
@export var attack_cooldown: float = 0.65 # Ataca más seguido

@export_group("Combate IA")
@export var vida_maxima: int = 22          # ~2× el Caballero Malo (10)
@export var poder_ataque: int = 1          # Más daño por golpe
...
func _ready() -> void:
	...
	# FÍSICA: Capa 3, solo choca con mapa (Capa 1)
...
func _efecto_dano() -> void:
	...
	# El vikingo flashea en naranja para diferenciarse visualmente del Caballero Malo (rojo)
