...
/** @type {string} */
const CACHE_VERSION = '1781312565|2968975387';
/** @type {string} */
const CACHE_PREFIX = 'Freedom Knight-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'FreedomKnight1.1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["FreedomKnight1.1.html","FreedomKnight1.1.js","FreedomKnight1.1.offline.html","FreedomKnight1.1.icon.png","FreedomKnight1.1.apple-touch-icon.png","FreedomKnight1.1.audio.worklet.js","FreedomKnight1.1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["FreedomKnight1.1.wasm","FreedomKnight1.1.pck","FreedomKnight1.1.side.wasm"];
